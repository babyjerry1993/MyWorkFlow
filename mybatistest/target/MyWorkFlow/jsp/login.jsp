...
<link href="<%=request.getContextPath()%>/css/login2.css"
					...
					<div class="login_form">
						<form action="<%=request.getContextPath()%>/login.do"
							...
							<div id="loginError" align="center"
								class="warning alert alert-warning" role="alert">
							...
							<div class="uinArea" id="uinArea">
								...
								<div class="inputOuter" id="uArea">
									<input type="text" style="color: #AAA" name="username"
										class="inputstyle" placeholder="Username" /> <span
							...
							<div class="pwdArea" id="pwdArea">
								...
								<div class="inputOuter" id="pArea">
									<input type="password" style="color: #AAA" name="userpassword"
										class="inputstyle" placeholder="Password" /> <span
